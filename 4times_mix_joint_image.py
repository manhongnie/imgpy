...
ok_dir = './zhihao_0712/small_images/ok/'   #path of input data
generate_path = './zhihao_0712/0712-1/'
ng_dir = './zhihao_0712/small_images/double/ng/'	
...
shape = ( 700, 600 , 3) # unit of joint image
#shape = (400 ,400, 3)
image_type = '.bmp'
